 ...
 **1. Environment Variables**
 Why did we put BASE URI in environment variables instead of hardcoding it?  
...
- It helps prevent confusion between “resource exists but empty” vs “resource doesn’t exist.”  
- It allows clients to handle errors properly and improves API reliability.


 **4. Testing**
Question: Show a successful GET request  
